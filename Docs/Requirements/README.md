...
15. [NETWORK_SESSION_REQUIREMENTS.md](NETWORK_SESSION_REQUIREMENTS.md)：监听主机、好友连接、会话生命周期与断线边界。
16. [SUPPORT_AND_COMMUNICATION_REQUIREMENTS.md](SUPPORT_AND_COMMUNICATION_REQUIREMENTS.md)：单人训练、文字聊天、标记与后续距离语音。
17. [SYSTEM_REQUIREMENTS.md](SYSTEM_REQUIREMENTS.md)：功能系统清单、数据关系和阶段优先级。
18. [TECHNICAL_REQUIREMENTS.md](TECHNICAL_REQUIREMENTS.md)：联机、性能、可维护性、存档和构建等非功能需求。
19. [CONTENT_AND_ART.md](CONTENT_AND_ART.md)：3D 表现、资产预算、可读性和内容生产规则。
20. [MVP_AND_ACCEPTANCE.md](MVP_AND_ACCEPTANCE.md)：原型、MVP 边界、验收和完成定义。
21. [OPEN_QUESTIONS.md](OPEN_QUESTIONS.md)：需要项目推动者明确选择的问题与决策顺序。
