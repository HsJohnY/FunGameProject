...
17. [PERFORMANCE_REQUIREMENTS.md](PERFORMANCE_REQUIREMENTS.md)：同类硬件参考、帧率、画质与 MVP 性能边界。
18. [SYSTEM_REQUIREMENTS.md](SYSTEM_REQUIREMENTS.md)：功能系统清单、数据关系和阶段优先级。
